...
try {
    ...
    console.log("Number of contacts before deletion:", personalContacts.countContacts());

    // Delete a contact by name
    personalContacts.removeContactByName('John', 'Doe');

    console.log("Contacts after deletion:", personalContacts.listContacts());
    console.log("Number of contacts after deletion:", personalContacts.countContacts());
} catch (error) {
