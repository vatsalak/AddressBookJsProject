...
addressBook.printSortedContacts(addressBook.sortByCity());

console.log("\nContacts sorted by state:");
addressBook.printSortedContacts(addressBook.sortByState());

console.log("\nContacts sorted by zip code:");
addressBook.printSortedContacts(addressBook.sortByZip());
